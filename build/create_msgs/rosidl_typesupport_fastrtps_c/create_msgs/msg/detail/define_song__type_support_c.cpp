...
bool cdr_serialize_create_msgs__msg__DefineSong(
  const create_msgs__msg__DefineSong * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_msgs
bool cdr_deserialize_create_msgs__msg__DefineSong(
  eprosima::fastcdr::Cdr & cdr,
  create_msgs__msg__DefineSong * ros_message)
{
  // Field name: song
  {
    cdr >> ros_message->song;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_msgs
bool cdr_serialize_key_create_msgs__msg__DefineSong(
  const create_msgs__msg__DefineSong * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: song
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_msgs
size_t get_serialized_size_key_create_msgs__msg__DefineSong(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DefineSong__ros_msg_type * ros_message = static_cast<const _DefineSong__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_msgs
size_t max_serialized_size_key_create_msgs__msg__DefineSong(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const create_msgs__msg__DefineSong * ros_message = static_cast<const create_msgs__msg__DefineSong *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_create_msgs__msg__DefineSong(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  create_msgs__msg__DefineSong * ros_message = static_cast<create_msgs__msg__DefineSong *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_create_msgs__msg__DefineSong(cdr, ros_message);
}
