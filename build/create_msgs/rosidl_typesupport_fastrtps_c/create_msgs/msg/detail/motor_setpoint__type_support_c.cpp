  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const create_msgs__msg__MotorSetpoint * ros_message = static_cast<const create_msgs__msg__MotorSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_create_msgs__msg__MotorSetpoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  create_msgs__msg__MotorSetpoint * ros_message = static_cast<create_msgs__msg__MotorSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_create_msgs__msg__MotorSetpoint(cdr, ros_message);
}
